...
public class AvmCollectTO implements AvmDataModel {
	...
	private AvmCollectTO(List<AvmVoiceTO> voice, AvmShortTextTO short_text, String imageUrl, String text, String value,
			String match, String url, Boolean quick_reply) {
		this.voice = voice;
	...
	public static class Builder {
		...
		public AvmCollectTO build() {
			return new AvmCollectTO(voice, short_text, imageUrl, text, value, match, url, quick_reply);
		}
	}
